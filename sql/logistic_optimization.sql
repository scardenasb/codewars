-- You are the owner of the Grocery Store. All your products are in the database, that you have created after 
-- CodeWars SQL excercises!:)
--
...
--
-- You have to find out how many different type of products you buy from each producer. If you take only few items from 
-- some of them you will stop going there to save the gasoline:)
--
